...
data class Sort(val mode: Mode, val direction: Direction) {
    ...
    /**
     * Sort a list of [SongFolder]s.
     *
     * @param folders The list of [SongFolder]s.
     * @return A new list of [SongFolder]s sorted by this [Sort]'s configuration.
     */
    fun folders(folders: Collection<SongFolder>): List<SongFolder> {
    ...
    sealed interface Mode {
        ...
        fun sortFolders(folders: MutableList<SongFolder>, direction: Direction) {
        ...
        data object ByName : Mode {
            ...
            override fun sortFolders(folders: MutableList<SongFolder>, direction: Direction) {
                when (direction) {
                    Direction.ASCENDING -> folders.sortBy { it.name.lowercase() }
                    Direction.DESCENDING -> folders.sortByDescending { it.name.lowercase() }
                }
            }
        }
