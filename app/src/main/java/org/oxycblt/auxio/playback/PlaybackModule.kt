...
interface PlaybackModule {
    ...
    @Singleton
    @Binds
    fun playlistSkipSettings(impl: PlaylistSkipSettingsImpl): PlaylistSkipSettings

    @Singleton
    @Binds
    fun playlistProgressStore(impl: PlaylistProgressStoreImpl): PlaylistProgressStore
