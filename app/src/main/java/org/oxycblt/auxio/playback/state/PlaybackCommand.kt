...
interface PlaybackCommand {
    ...
    interface Factory {
        ...
        fun songFrom(song: Song, songs: List<Song>, shuffle: ShuffleMode): PlaybackCommand?
...
constructor(
    ...
    override fun songFrom(song: Song, songs: List<Song>, shuffle: ShuffleMode) =
        newCommand(song, null, songs, shuffle)
